...
def set_light_level_color_temperature(_serialDevice, _lightLevelValue =50, _colourTemperatureValue = 3900):
    ...
    if _serialDevice.isOpen():
        try:
            ...
            serial_msg = '25' + str(LUMINAIRE_ID) + '0017' + str(DALI_LIGHT_LEVEL_HEX_ARRAY[lightValIndex]) + str(COLOUR_TEMPERATURE_HEX_ARRAY[colourTempValIndex]) + LUMIAIRE_MODE + 'FF\n'
            # uncomment for debugging
    ...
    if Port_name:
        ...
        if Serial_Device:
            ...
            while True:
                ...
                set_light_level_color_temperature(Serial_Device, i*5, 3900+i*100)
                i+=1
